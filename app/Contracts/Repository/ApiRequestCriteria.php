...
class ApiRequestCriteria extends RequestCriteria
{
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        $orderBy = $this->request->query(config('repository.criteria.params.orderBy', 'orderBy'), $model->getModel()->getKeyName());
        ...
        $searchJoin = $this->request->query(config('repository.criteria.params.searchJoin', 'searchJoin'), null);
